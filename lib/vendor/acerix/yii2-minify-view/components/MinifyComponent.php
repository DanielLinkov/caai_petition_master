...
namespace acerix\yii\minify\components;

use acerix\yii\minify\View;
use yii\caching\Cache;
use yii\caching\TagDependency;

/**
 * Class MinifyComponent
 * @package acerix\yii\minify\components
 */
abstract class MinifyComponent
{
    ...
    protected function prepareResultFile($resultFile)
    {
        ...
        if ($AssetManager->appendTimestamp) {
            $file .= '?v=' . filemtime($resultFile);
        }
